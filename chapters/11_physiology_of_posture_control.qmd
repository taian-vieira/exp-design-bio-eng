...
![Plausible model explaining how pathologies may accelerate the decline of postural stability with age. Figure created based on the age-model reported by Shuppert and Horak @shupert99 ](/include/images/part_1/ch_1/1-1-1_age-and-balance.png){#fig-1-1-1 width=80%}
...
![Maturation of the inter-segmental control of posture. AI-generated illustration created with ChatGPT (OpenAI), 2026.](/include/images/part_1/ch_1/1-1-2_posture-development.png){#fig-1-1-2 width=80%}
...
![Analogy for understanding the key aspects involved in posture control, from sensing to acting. AI-generated illustration created with ChatGPT (OpenAI), 2026.](/include/images/part_1/ch_1/1-1-6_doll-analogy.png){#fig-1-1-6 width=70%}
